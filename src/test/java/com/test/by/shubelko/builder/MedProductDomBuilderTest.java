...
public class MedProductDomBuilderTest {
    ...
    @Test
    public void testBuildMedProducts() throws MedProductException{
        ...
        domBuilder.buildSetMedProducts(xmlPath);
        Set<AbstractMedProduct> actual = domBuilder.getMedProducts();

        assertEquals(actual, expected);
    }

    @Test(expectedExceptions = MedProductException.class)
    public void testBuildMedProductsFileNotFound() throws MedProductException {
        String xmlPath = "Java is great!";
        domBuilder.buildSetMedProducts(xmlPath);
    }
