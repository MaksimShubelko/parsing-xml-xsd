...
public class MedProductStaxBuilderTest {
    ...
    @Test
    public void testBuildMedProductsPositive() throws MedProductException {
        ...
        staxBuilder.buildSetMedProducts(xmlPath);
        Set<AbstractMedProduct> actual = staxBuilder.getMedProducts();
